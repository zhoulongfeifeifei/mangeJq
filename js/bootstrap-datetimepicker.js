...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev" style="background:#393e3c;color:#fff"><i class="fa fa-angle-left"/><</th>'+
								'<th colspan="5" class="switch"></th>'+
								'<th class="next" style="background:#393e3c;color:#fff"><i class="fa fa-angle-right"/>></th>'+
							'</tr>'+
						'</thead>',
